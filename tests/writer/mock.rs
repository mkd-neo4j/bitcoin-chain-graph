...
mod mock_writer_tests {
    ...
    // M7: Phase 5 (calculate_amounts) and write_simplified_layer tests removed
    // These operations are now done in Rust during ingestion, not as separate DB operations
